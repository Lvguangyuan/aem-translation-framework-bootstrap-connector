...
public class BootstrapTranslationServiceImpl extends AbstractTranslationService implements TranslationService {
    ...
    // Constructor
    public BootstrapTranslationServiceImpl(Map<String, String> availableLanguageMap, Map<String, String> availableCategoryMap, String name,
                                           Boolean isPreviewEnabled, Boolean isPseudoLocalizationDisabled, String exportFormat, String dummyConfigId,
    ...
    private ResourceResolver getResourceResolver() {
        try {
            return resourceResolverFactory.getServiceResourceResolver(Collections.singletonMap("sling.service.subservice", "bootstrap-service"));
        } catch (LoginException e) {
            log.error("Login user bootstrap-service failed. ", e);
        }
        return null;
    }
    ...
    private void safeCloseResolver(ResourceResolver resolver) {
    ...
    public String uploadTranslationObject(String strTranslationJobID, TranslationObject translationObject)
        ...
        if (isPreviewEnabled) {
            ...
            try {
                ...
                safeCloseResolver(resourceResolver);
            }
        }
